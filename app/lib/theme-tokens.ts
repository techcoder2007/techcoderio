...
export const FONT_FAMILIES: Record<FontFamily, { stack: string; label: string }> = {
	"noto-mono": { stack: '"Noto Sans Mono", ui-monospace, monospace', label: "Noto Sans Mono" },
	system: { stack: "ui-sans-serif, system-ui, sans-serif", label: "System Default" },
	ubuntu: { stack: '"Ubuntu", ui-sans-serif, sans-serif', label: "Ubuntu" },
	cantarell: { stack: '"Cantarell", ui-sans-serif, sans-serif', label: "Cantarell" },
	dejavu: { stack: '"DejaVu Sans", ui-sans-serif, sans-serif', label: "DejaVu Sans" },
	liberation: {
