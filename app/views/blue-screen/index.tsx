...
const BlueScreen: React.FC<Props> = ({
  ...
  return (
    <div
      ...
      style={{ fontFamily: "'Segoe UI', Roboto, system-ui, -apple-system, 'Helvetica Neue', Arial" }}
    >
      <div className="max-w-5xl w-[92%] md:w-4/5 lg:w-3/5">
        <div className="flex flex-col md:flex-row gap-8 items-start">
          <div className="flex-1">
            <h1 id="bsod-title" className="text-7xl md:text-8xl mb-8 leading-none font-light">
              :(
            </h1>
        ...
        <div className="mt-12 text-sm text-white/90">
          <div className="md:ml-0">
            Collecting data for crash dump: <span className="font-mono">{progress}%</span>
          </div>
